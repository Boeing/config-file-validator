...
## Build
The project can be downloaded and built from source using an environment with Go 1.24+ installed. After a successful build, the binary can be moved to a location on your operating system PATH.
