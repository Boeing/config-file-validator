...
This page walks through a first run of the validator. It assumes you have already [installed](./installation.md) the tool.
...
The validator picks it up automatically. See [Configuration File](./guides/configuration-file.md) for all available options.
