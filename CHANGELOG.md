...
- TOML formatting now keeps arrays nested inside inline tables on a single line, even when the source array is expanded or exceeds the configured column width (closes #631).
